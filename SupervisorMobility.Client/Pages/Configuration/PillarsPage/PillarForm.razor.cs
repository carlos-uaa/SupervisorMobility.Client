        ...
        private async void ExectPillarAsync()
        {
            ...
            switch (PageState)
                    ...
                    if (result != null)
                    {
                        ...
                        Snackbar.Clear();
                        Snackbar.Configuration.PositionClass = Defaults.Classes.Position.BottomLeft;
                        Snackbar.Add($"Create Pillar Succes", Severity.Info);
                    }
                    else
                    {
                        Snackbar.Clear();
                        Snackbar.Configuration.PositionClass = Defaults.Classes.Position.BottomLeft;
                        Snackbar.Add($"Error in create", Severity.Error);
                        ExecBtnPress = false;
                    }
                    break;
                case 3:
                    ...
                    if (resultUpdate != null)
                    {
                        ...
                        Snackbar.Clear();
                        Snackbar.Configuration.PositionClass = Defaults.Classes.Position.BottomLeft;
                        Snackbar.Add($"Update Pillar Succes", Severity.Info);
                    }
                    else
                    {
                        Snackbar.Clear();
                        Snackbar.Configuration.PositionClass = Defaults.Classes.Position.BottomLeft;
                        Snackbar.Add($"Error in Update", Severity.Error);
                        ExecBtnPress = false;
                    }
