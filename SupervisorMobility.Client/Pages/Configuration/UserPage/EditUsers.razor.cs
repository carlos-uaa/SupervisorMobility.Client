    ...
    public partial class EditUsers
    {
        ...
        private async Task setActiveUser(int userType)
        {
            ...
            if (newUserType != 0 && newUserType == _usercopy.UserType)
            {
                try
                {
                    // Recargar desde la base de datos para asegurar que las colecciones (Áreas, Subordinados) estén completas
            ...
            // Solo llamamos a la actualización de listas auxiliares si NO hemos restaurado el usuario original.
            // Si lo restauramos, se supone que ya tiene sus listas cargadas correctamente desde el servicio.
            // Al llamar a ShowAreasInvokeByPlantSelector() aquí, se estaban limpiando listas como _areasManager
        ...
        private async void UpdateUserAsync()
        {
            ...
            {
                // promoci�n de Tipo 5 Manager a Tipo 1 Admin / Tipo 6 Final Line
            ...
            {
                //  promoci�n de Tipo 2 SSV a Tipo 5 Manager
                ReasignUsersOptionsView = true;
            ...
            {
                //  promoci�n de Tipo 3 SV a Tipo 2 SV
                ReasignUsersOptionsView = true;
