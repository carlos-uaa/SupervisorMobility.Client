...
namespace SupervisorMobility.Client.Services.SOS_Services.SOSAnalysisServices
{
    public interface ISOSAnalysisService
    {
        ...
        Task<List<SOSAnalysis>> GetAllSOSAnalysisByArea(int Area_Id, bool includeImages = false, bool includeNotes = false, bool includeLogbooks = false, bool includeSpecialCases = false, bool includeSOS = false);
