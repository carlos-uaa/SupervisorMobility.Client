namespace SupervisorMobility.Client.Services.KaizenService
{
    public interface IKaizenService
    {
        ...
        Task<Kaizen> GetKaizenById(int kaizenId, bool includeNavigation = false, bool includePeople = false, bool includeEvidences = false, bool includeTransactions = false);
